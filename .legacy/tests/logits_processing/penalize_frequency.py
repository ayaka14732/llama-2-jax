...
from lib.logits_processing import penalize_frequency
...
# seq1: 1 for 1 time, 2 for 1 time, 3 for 1 time
# seq2: 0 for 1 time, 2 for 1 time, 3 for 2 time

assert logits.shape == (batch_size, vocab_size)
assert seq.shape == (batch_size, seq_len)
assert attn_mask.shape == (batch_size, seq_len)

y = jnp.array([[0., 0., 1., 2., 4.], [0., 2., 2., 2., 5.]])
y_hat = penalize_frequency(logits, seq, attn_mask, 1.)
