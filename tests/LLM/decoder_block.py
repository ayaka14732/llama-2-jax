...
from lib.LLM.decoder_block import forward_decoder_block
from lib.LLM_params.convert_params import convert_decoder_block
...
y_jax = pt2jax(y_pt)
y_hat_jax, _ = forward_decoder_block(params_jax, seq_jax, mask_jax, model_config=config_jax)
